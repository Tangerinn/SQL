...
(
employee_id int primary key,
-- speciality ENUM('Strings', 'Percussion', 'Woodwind', 'Electronics'), mssql doesn't support enum
    speciality varchar(50) CHECK (speciality IN ('Strings', 'Percussion', 'Woodwind', 'Electronics')),
...
payment_method varchar(20) check (payment_method in ('Cash', 'Credit Card', 'UPI', 'Debit Card')),
